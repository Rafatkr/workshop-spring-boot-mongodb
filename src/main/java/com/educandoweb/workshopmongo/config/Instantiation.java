...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User maria = new User(null, "Maria Brown", "maria@gmail.com", 1);
		User alex = new User(null, "Alex Green", "alex@gmail.com", 1);
		User bob = new User(null, "Bob Grey", "bob@gmail.com", 2);
